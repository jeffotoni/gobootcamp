  ...
  function initGoPlayground() {
    ...
    for (var i = 0; i < snippets.length; i++) {
      ...
      if (!init) {
        ...
        '       <div class="buttons">' +
        '         <a class="run btn btn-actions-go" title="Run this code [shift-enter]">Run</a>' +
        '         <a class="fmt btn btn-actions-go" title="Format this code">Format</a>' +
        '         <a class="share btn btn-actions-go" title="Share this code">Share</a>' +
        '       </div>' +
        '     </div>' +
        ' </div>' +
        '</div>'
